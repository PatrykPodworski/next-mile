...
export type CartProductFragment = { __typename?: 'Product', id: string, name: string, price: number, description: string, images: Array<{ __typename?: 'Asset', url: string }> } & { ' $fragmentName'?: 'CartProductFragment' };
...
export type CreateProductReviewMutationMutationVariables = Exact<{
  review: ReviewCreateInput;
}>;


export type CreateProductReviewMutationMutation = { __typename?: 'Mutation', createReview?: { __typename?: 'Review', id: string } | null };
...
export const CreateProductReviewMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateProductReviewMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"review"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ReviewCreateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createReview"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"review"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<CreateProductReviewMutationMutation, CreateProductReviewMutationMutationVariables>;